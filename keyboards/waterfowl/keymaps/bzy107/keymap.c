 ...
 * |   A  |   S  |   D  |   F  |   G  |                      |   H  |   J  |   K  |   L  |   ;  |
 * |------+------+------+------+------|  ,-----.    ,-----.  |------+------+------+------+------|
 * |   Z  |   X  |   C  |   V  |   B  |  |CAPS |    |NUMLK|  |   N  |   M  |   ,  |   .  | / Alt|
 * `----------------------------------'  `-----'    `-----'  `----------------------------------'
 *          ,-----.   ,--------------------.            ,--------------------.   ,-----. 
 *          |  1  |   | TWO |  Spc |  Sft  |            | BkSp |Ent/GUI| ONE |   |  4  |
 *          `-----'   `--------------------'            `--------------------'   `-----'
 */
[_ZERO] = LAYOUT(
	...
	KC_1, TWO, KC_SPC, KC_LSFT, KC_CAPS,						KC_NUM, KC_BSPC, MT(MOD_LGUI, KC_ENT), ONE, KC_4
),
 ...
 * |  Tab |   %  |   *  |   &  |   '  |                      |   =  |  F5  |  F6  |  F7  |  F8  |
 * |------+------+------+------+------|  ,-----.    ,-----.  |------|------+------+------+------|
 * | Ctrl |   `  |   ^  |   \  |  Sft |  |CAPS |    |NUMLK|  |   -  |  F9  | F10  |  F11 |  SIX |
 * `----------------------------------'  `-----'    `-----'  `----------------------------------'
 *          ,-----.   ,--------------------.            ,--------------------.   ,-----. 
 *          |  1  |   | THREE|  Spc |  Sft |            |  DEL |Ent/GUI|     |   |  4  |
 *          `-----'   `--------------------'            `--------------------'   `-----'
 */
[_ONE] = LAYOUT(
	...
	KC_1,		THREE,		KC_SPC,		KC_LSFT,	KC_CAPS,			KC_NUM,		KC_DEL,	MT(MOD_LGUI, KC_ENT),	_______,	KC_4
),
 ...
 * |   6  |   7  |   8  |   9  |   0  |                      |   =  |  ←   |  (   |   →  |   )  |
 * |------+------+------+------+------|  ,-----.    ,-----.  |------+------+------+------+------|
 * | Ctrl | Tab  |  Alt | Sft  | FIVE |  |CAPS |    |NUMLK|  |   -  |      |   ↓  |   {  |   }  |
 * `----------------------------------'  `-----'    `-----'  `----------------------------------'
 *          ,-----.   ,--------------------.            ,--------------------.   ,-----. 
 *          |  1  |   | DEL | SPACE | TAB  |            | Del  |Ent/GUI|FOUR |   |  4  |
 *          `-----'   `--------------------'            `--------------------'   `-----'
 */
[_TWO] = LAYOUT(
    ...
    KC_1,		_______,	KC_SPC,		KC_LSFT,	KC_CAPS,		KC_NUM,		KC_DEL,		MT(MOD_LGUI, KC_ENT),	FOUR,		KC_4
),
 ...
 * |   A  |   S  |   D  |   F  |   G  |                      |   H  |   J  |   K  |   L  |   ;  |
 * |------+------+------+------+------|  ,-----.    ,-----.  |------+------+------+------+------|
 * |   Z  |   X  |   C  |   V  |   B  |  |CAPS |    |NUMLK|  |   N  |   M  |  Alt | Ctrl |  GUI |
 * `----------------------------------'  `-----'    `-----'  `----------------------------------'
 *          ,-----.   ,--------------------.            ,--------------------.   ,-----. 
 *          |  1  |   |      |  Spc |  Sft |            | BkSp |  Ent |      |   |  4  |
 *          `-----'   `--------------------'            `--------------------'   `-----'
 */
[_THREE] =  LAYOUT(
	KC_Q,	KC_W,		KC_E,		KC_R,    KC_T,			KC_Y,	KC_U,		KC_I,		KC_O,    KC_P,
	...
	KC_1,	_______,	KC_SPC,		KC_LSFT, KC_CAPS,		KC_NUM,	KC_BSPC,	KC_ENT,		_______, KC_4
),
...
[_FOUR] =  LAYOUT(
	...
	KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,      KC_NO,	KC_NO, KC_NO, KC_NO, KC_NO,
	KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,      KC_NO,	KC_NO, KC_NO, KC_NO, KC_NO,
	KC_1,  KC_NO, KC_NO, KC_NO, KC_CAPS,	KC_NUM, KC_NO, KC_NO, KC_NO, KC_4
),
...
[_FIVE] =  LAYOUT(
	...
	MAC_H,	WIN_H, KC_NO, KC_NO,	KC_NO,				KC_RALT,	KC_TILD,	KC_NO, KC_NO, KC_NO,
    KC_1,	KC_NO, KC_NO, RESET,	KC_CAPS,			KC_NUM,		KC_NO,		KC_NO, KC_NO, KC_4
),
};
